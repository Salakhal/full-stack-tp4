...
export const livreController = {
  ...
  ajouterForm: async (req, res) => {
    ...
    res.render('pages/livres/ajouter', { title: 'Ajouter un livre', livre: {}, auteurs });
  },
  ...
  details: async (req, res) => {
    ...
    if (!rows[0]) {
      return res.status(404).render('pages/404', { title: 'Page non trouvée' });
    }
  ...
  modifierForm: async (req, res) => {
    ...
    res.render('pages/livres/modifier', { title: 'Modifier un livre', livre: livres[0], auteurs });
  },
